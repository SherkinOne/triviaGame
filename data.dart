...
class DatabaseHelper {
  ...
  static final tableQuestions = 'savedQuestions';
  ...
  Future<List<Map<String, dynamic>>> queryAllRows() async {
    Database db = await instance.database;
    return await db.query(tableQuestions);
  }
  ...
  Future<int> delete(String question) async {
    Database db = await instance.database;
    return await db
        .delete(tableQuestions, where: '$columnQuestion  = ?', whereArgs: [question]);
  }
}